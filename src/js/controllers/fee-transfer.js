denningOnline
  .controller('feeTransListCtrl', function(NgTableParams, feeTransService, Auth, $state) {
    var self = this;
    ...
    self.tableFilter = new NgTableParams({
      ...
      getData: function(params) {
        return feeTransService.getList(params.page(), params.count(), self.keyword)
        .then(function (data) {
  ...
  .controller('feeTransEditCtrl', function($stateParams, feeTransService, $state, Auth,
                                          ...
                                          uibDateParser, $uibModal, NgTableParams) 
  {
    ...
    if ($stateParams.id) {
      self.title = 'Edit Fee Transfer';
      feeTransService.getItem($stateParams.id).then(function (item){
    ...
    self.save = function () {
      ...
      feeTransService.save(entity, self.entity_).then(function (item) {
