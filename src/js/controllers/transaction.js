denningOnline
  ...
  .controller('generalJournalEditCtrl', function($stateParams, transactionService, $state, Auth,
  ...
  .controller('debitNoteEditCtrl', function($stateParams, transactionService, $state, Auth,
                                            refactorService, matterService, growlService,
                                            matterCodeService, presetbillService,
                                            uibDateParser, $uibModal, NgTableParams) 
  {
  ...
  .controller('IATEditCtrl', function($stateParams, transactionService, $state, Auth,
                                      refactorService, matterService, growlService,
                                      matterCodeService, presetbillService,
                                      uibDateParser, $uibModal, NgTableParams) 
  {
