materialAdmin
    ...
    .controller('occupationDeleteModalCtrl', function ($scope, $modalInstance, contact, occupationService, $state) {
        $scope.ok = function () {
            occupationService.delete(contact).then(function(contact) {
                $state.reload();
            })
            .catch(function(err){
                //Handler
    ...
    .controller('occupationEditCtrl', function($filter, $stateParams, occupationService, $state) {
        ...
        function save() {
            occupationService.save(self.contact).then(function(contact) {
