materialAdmin
    ...
    .controller('loginCtrl', function ($rootScope, $scope, Auth, $window, $state, legalFirmListService) {
        ...
        // legalFirmListService.getList().then(function(data){
        //     self.legalFirms = [];
        //     data.forEach(function(item){
        //         self.legalFirms.push(item);
        //     })
        // })
        self.legalFirms = [{
            "IDNo": null,
